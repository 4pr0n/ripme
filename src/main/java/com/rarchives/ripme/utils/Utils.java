...
public class Utils {
    ...
    private static String getConfigPath() {
        try {
            return new File(".").getCanonicalPath() + File.separator + CONFIG_FILE;
        } catch (Exception e) {
            LOGGER.error("Method getConfigPath ", e);
            return "." + File.separator + CONFIG_FILE;
        }
    }
    ...
    public static List<Class<?>> getClassesForPackage(String pkgname) {
        ...
        try {
            ...
            LOGGER.error("Method getClassesForPackage", e);
            directory = null;
        }
    ...
    public static void configureLogger() {
        ...
        try {
            ...
            LOGGER.error("Method configureLogger", e);
        }
    }
