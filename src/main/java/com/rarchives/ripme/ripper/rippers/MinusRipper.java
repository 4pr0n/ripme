...
public class MinusRipper extends AlbumRipper {
    ...
    public String getGID(URL url) throws MalformedURLException {
        ...
        Pattern p = Pattern.compile("^https?://minus\\.com/m([a-zA-Z0-9]+).*$");
        ...
        throw new MalformedURLException(
                "Expected minus.com album URL formats: username.minus.com or "
                        + "username.minus.com/m... or minus.com/m... Got: " + url);
    }
    ...
    private void ripAccount(URL url) throws IOException {
        ...
        int page = 1;
        while (true) {
            String jsonUrl = "http://" + user + ".minus.com/api/pane/user/" + user + "/shares.json/" + page;
    ...
    private void ripAlbum(URL url, String subdir) throws IOException {
        ...
        if (albumDoc == null || !subdir.isEmpty())
            albumDoc = Http.url(url).get();
        ...
        if (m.matches()) {
            ...
            for (int i = 0; i < items.length(); i++) {
                ...
                String image = "http://i.minus.com/i" + item.getString("id") + extension;
                String prefix = "";
