...
public class BcfakesRipper extends AbstractHTMLRipper {
    ...
    public String getGID(URL url) throws MalformedURLException {
        Pattern p = Pattern.compile("^https?://[wm.]*bcfakes.com/celebritylist/([a-zA-Z0-9\\-_]+).*$");
        ...
        throw new MalformedURLException(
                "Expected bcfakes gallery format: http://www.bcfakes.com/celebritylist/name Got: " + url
        );
    }
