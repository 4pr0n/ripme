...
public class DrawcrowdRipper extends AbstractHTMLRipper {
    ...
    public String getGID(URL url) throws MalformedURLException {
        ...
        throw new MalformedURLException("Expected drawcrowd.com gallery format: drawcrowd.com/username Got: " + url);
    }
    ...
    public List<String> getURLsFromPage(Document page) {
        ...
        for (Element thumb : page.select("div.item.asset img")) {
            ...
            image = image.replaceAll("/medium/", "/large/").replaceAll("/small/", "/large/");
            imageURLs.add(image);
        }
