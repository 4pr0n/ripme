...
public class ImagevenueRipper extends AbstractHTMLRipper {
    ...
    public String getGID(URL url) throws MalformedURLException {
        Pattern p = Pattern.compile("^https?://.*imagevenue.com/galshow.php\\?gal=([a-zA-Z0-9\\-_]+).*$");
        ...
        throw new MalformedURLException(
                "Expected imagevenue gallery format: http://...imagevenue.com/galshow.php?gal=gallery_.... Got: " + url
        );
    }
