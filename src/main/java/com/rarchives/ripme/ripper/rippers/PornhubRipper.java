...
public class PornhubRipper extends AlbumRipper {
    ...
    public String getGID(URL url) throws MalformedURLException {
        Pattern p = Pattern.compile("^.*pornhub\\.com/album/([0-9]+)$");
        ...
        throw new MalformedURLException(
                "Expected pornhub.com album format: http://www.pornhub.com/album/#### Got: " + url
        );
    }
    ...
    public void rip() throws IOException {
        ...
        if (albumDoc == null) {
            ...
            albumDoc = Http.url(nextUrl).referrer(this.url).get();
        }
    ...
    private class PornhubImageThread extends Thread {
        ...
        private void fetchImage() {
            try {
                Document doc = Http.url(this.url).referrer(this.url).get();
