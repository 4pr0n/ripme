...
public class FlickrRipper extends AbstractHTMLRipper {
    ...
    private static final String FLICKR_URL = "http://www.flickr.com";
    private int page = 1;
    ...
    public URL sanitizeURL(URL url) throws MalformedURLException {
        ...
        // Strip out https
        sUrl = sUrl.replace("https://secure.flickr.com", FLICKR_URL);
    ...
    public String getGID(URL url) throws MalformedURLException {
        ...
        throw new MalformedURLException(
                "Expected flickr.com URL formats: flickr.com/photos/username or "
                        + "flickr.com/photos/username/sets/albumid Got: " + url);
    }
        ...
        for (Element thumb : page.select("a[data-track=photo-click]")) {
            ...
            */
            ...
            if (imagePage.startsWith("/"))
                imagePage = FLICKR_URL + imagePage;
